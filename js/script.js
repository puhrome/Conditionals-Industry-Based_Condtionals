...
if (photos){// if condition is true
    console.log ("You have" + photos + " gigs of storage");//print to console
}else{// if condition is null;
    alert("Please enter a valid number");//alert a user input
}
...
(memSpace >= storageUsed) ? console.log("Whew! You can save all of your hard work in one place!"): console.log("Sorry you are at" + " " + driveSpace + "% total storage");
//create alert for statement of how much storage is left on memory card
alert("You have " + " " + memSpace + "% total storage left");//alert how much space is left